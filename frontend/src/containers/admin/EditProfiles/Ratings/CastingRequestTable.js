...
import CastingRequestTalent from 'containers/admin/EditProfiles/CastingRequests/CastingRequestTalent';
        ...
        { castingRequests.map((castingRequestTalent, index) => {
            return (
              <Grid item xs={12} key={index}>
                <CastingRequestTalent castingRequestTalent={castingRequestTalent} path={path} showStatus={false} />
              </Grid>
            );
          })
        }
