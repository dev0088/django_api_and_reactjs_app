...
import AerialistWhoMovesIntroForm from './aerialistWhoMovesIntroForm';


class AerialistWhoMovesIntro extends Component {
  ...
  render() {
    ...
    return (
      <TalentBuildProfileForm
        ContentLayout={AerialistWhoMovesIntroForm}
        formTitle={"My Aerialist Audition Videos Instructions"}
        formSubTitle={"(Aerialist Who Moves)"}
        nextLink={nextLink}
...
export default AerialistWhoMovesIntro;
