...
class AerialistWhoSingsIntroForm extends Component {

  renderAdditional() {
    const { classes } = this.props;
    let link = {
      pathname: '/talent/video-audition/aerialist-sings-more-intro',
    ...
    return (
      ...
      <Typography className={classes.descriptionText}>
        {`As you are an Aerialist Who Sings, `}
...
export default withStyles(styles)(AerialistWhoSingsIntroForm);
