...
import VocalistWhoActsIntroForm from './vocalistWhoActsIntroForm';


class VocalistWhoActsIntroScreen extends Component {
...
export default VocalistWhoActsIntroScreen;
