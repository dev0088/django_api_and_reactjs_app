...
import TalentVocalVideosForm from 'containers/talent/profile/build-profile/videos/auditions/vocal/talentVocalVideosForm';


class MyVocalAuditionVideos extends Component {
  ...
  render() {
    ...
    return (
      <TalentBuildProfileForm
        ContentLayout={TalentVocalVideosForm}
...
export default MyVocalAuditionVideos;
