...
import TalentDanceVideosForm from 'containers/talent/profile/build-profile/videos/auditions/dance/talentDanceVideosForm';


class MyDanceAuditionVideos extends Component {
  ...
  render() {
    ...
    return (
      <TalentBuildProfileForm
        ContentLayout={TalentDanceVideosForm}
...
export default MyDanceAuditionVideos;
